...
(function esriMapScopeWrapper($) {
    require([
        ...
        var civilianSymbol = new TextSymbol({
            color: '#f50856',
            text: '\ue655',
            font: {
                size: 20,
        ...
        function showCivilians(argument) {
            pinGraphic = new Graphic({
                symbol: civilianSymbol,
        ...
        view.on('click', function handleViewClick(event) {
            ...
            var userPoints = event.mapPoint;
            userPoints.x = userPoints.x + 0.111111111;
            userPoints.y = userPoints.x + 0.111111111;

            pinCivilian = new Graphic({
                symbol: civilianSymbol,
                geometry: userPoints
            });
            view.graphics.add(pinCivilian);
